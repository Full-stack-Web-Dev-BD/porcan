/*
    https://bscscan.com/address/0xC1e18738F181b65a6C22Fed9Ef9eb9ebDE9c0aBD
...
contract CoinToken is Context, IERC20, Ownable {
    ...
    uint256 private _changeFeeDays;
    ...
    constructor() payable {
        ...
        address feeaddress = 0xdD90e91943c347ae01494EfEEfef22c5E480b0f3;
        address tokenOwner = msg.sender;
        uint256 changeFeeDays = 92;
    ...
    function _transfer(
        ...
        if (block.timestamp - _startTime > _changeFeeDays * 1 days) {
            _taxFee = 5;
            _devFee = 5;
            _liquidityFee = 5;
        }
